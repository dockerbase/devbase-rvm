...
run:
	docker run -it --rm --name dockerbase-devbase-rvm $(NAME):$(VERSION)
...
version:
	...
	#docker run -it --rm $(NAME):$(VERSION) sh -c " /home/devbase/.rvm/bin/rvm use default ; ruby -v " | tee -a COMPONENTS
	dos2unix COMPONENTS
